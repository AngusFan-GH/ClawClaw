...
const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <select
        className={cn(
          'flex h-10 w-full rounded-xl border border-input/80 bg-card/80 px-3.5 py-2 text-sm ring-offset-background backdrop-blur-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/70 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-45 appearance-none bg-[length:16px_16px] bg-[right_12px_center] bg-no-repeat',
